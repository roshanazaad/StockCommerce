...
import './App.css';
import fruits_veges from './Images/fruits_veges4.png';
    ...
    return (
      <div className="App">
        <header className="App-header" >
          SPARKS &nbsp; &nbsp; &nbsp;
          <input type="text" placeholder="Search" size="40" value={this.state.searchText} onChange={this.handleSearch}/>
          &nbsp; &nbsp;
          ...
          <p></p>
          <img src={fruits_veges} style={{height:"300px" , width:"1000px"}} className="image"/>
          <div>
